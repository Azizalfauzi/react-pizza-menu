...
function Header() {
  ...
  return (
    <header className="header">
      <h1 style={style}>Zuha React Pizza Co.</h1>
    </header>
  );
}
  ...
  return (
    <main className="menu">
      ...
      {numPizza > 0 ? (
        <>
          <p>
            Authentice Italian cuisine. 6 creative dishes to choose from. All
...
function Order({ closeHour, openHour }) {
  return (
    <div className="order">
      <p>
        We're open from {openHour}:00 to {closeHour}:00.Come visit us or oder
        online!
      </p>
